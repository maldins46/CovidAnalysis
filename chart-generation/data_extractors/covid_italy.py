...
#RAW_DF = pd.read_csv('./data/opendata-covid-italia/dati-andamento-nazionale/dpc-covid19-ita-andamento-nazionale-latest.csv')
RAW_DF = pd.read_csv('/users/riccardomaldini/Desktop/CovidAnalysis/data/opendata-covid-italia/dati-andamento-nazionale/dpc-covid19-ita-andamento-nazionale.csv')
